...
productNum: industrialProductTypeListData[i]['products'].length.toString(), // Updated to reflect the number of products
isSubProduct: industrialProductTypeListData[i]['has_children'] as bool, // Updated to reflect if it is a subproduct based on having children
isFavourite: false,
