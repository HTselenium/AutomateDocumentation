...
extra: {
 ...
 'product_type_amount':industrialProductTypeListData[i]['product_type_amount'],
},
```
...
context.push(
 ...
 '${AppRoutes.productPortfolioIndustrial.path}/product/${industrialProductTypeListData[i]['category']}',
extra: {
