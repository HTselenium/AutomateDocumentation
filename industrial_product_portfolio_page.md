...
productNum: industrialProductTypeListData[i]['products'].toString(), // Updated to reflect new parameter 'products'
isSubProduct: industrialProductTypeListData[i]['has_children'] as bool, // Updated to reflect actual condition of having children
isFavourite: false,
